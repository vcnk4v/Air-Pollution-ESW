...
const char* ssid = "omi_Fi";
const char* pass = "okay_123";
...
void loop() {
  ...
  if (!error) {
    ...
    temp.temperature = (-1)*(temp.temperature);
    ...
    String url = "https://api.thingspeak.com/update?api_key=" + String(writeAPIKey) +
                 "&field1=" + String(p25) +
                 "&field2=" + String(p10) +
                 "&field3=" + String(humidity.relative_humidity) +
                 "&field4=" + String(temp.temperature);
